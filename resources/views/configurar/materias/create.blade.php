@section('materias.create')
      ...
      <div class="modal-content animate-zoom" style="max-width:320px">
        ...
        <div class="px-6 caja-header text-center"><h3><strong>Introducir materia </strong></h3></div>
        <form class="px-6" method="POST" action="{{ route('materias.store') }}">
        @csrf
          <div class="py-6">
            <label for="materia_name"><b>Materia</b></label>
            
            <input type="text" class="d_block" placeholder="materia cursoLetra etapa"  value="{{ old('materia_name') }}"  autofocus name="materia_name">
            @error('materia_name')
