{{-- @section('estudiantes.create') --}}
      ...
      <div class="modal-content animate-zoom">
        ...
        <div class="px-6 caja-header text-center">
          <h3>Introducir grupo de estudiantes<span id="ver_materia_id"></span>
          </h3>
        </div>
        ...
        @csrf
            ...
            <div class= "hidden">
              ...
              <input type="text" id="materia_id" name="materia_id" value="{{ old('materia_id') }}" >
            </div>
          <div class="">  
            
              <label for="lista_completa">Lista de estudiantes</label>
              <textarea class="d_block" placeholder="Garcia Lorca, Federico;De Cervantes Saavedra, Miguel;Ruiz Picasso,Pablo;..." rows="6" autofocus name="lista_completa"></textarea>
